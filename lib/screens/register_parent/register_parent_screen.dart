  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        ...
        body: Consumer<RegisterParentProvider>(
                  ...
                  children: [
                    ...
                    if (provider.children.isNotEmpty)
                      Container(
                        ...
                        child: Column(
                          children: List.generate(provider.children.length, (
                            index,
                          ) {
                            return ListTile(
                              leading: const Icon(
                              ...
                              title: Text(provider.children[index]),
                              trailing: IconButton(
                                icon: const Icon(
                                  Icons.delete,
                                  color: Colors.red,
                                ),
                                onPressed: () => provider.removeChild(index),
                              ),
                            );
                          }),
                        ),
